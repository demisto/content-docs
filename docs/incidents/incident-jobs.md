...
For a better understanding of how jobs are implemented to trigger playbooks, read the [tutorial for adding indicators to a SIEM](../../content-repo/extra-docs/articles/tim-edl.md).
