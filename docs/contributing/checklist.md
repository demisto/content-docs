...
To create a new Content Pack structure, you should use the [`demisto-sdk init`](https://github.com/demisto/demisto-sdk/tree/master/demisto_sdk/commands/init#init) , as described in the [tutorial](../tutorials/tut-setup-dev#step-6-create-a-branch-and-integration-directory)
