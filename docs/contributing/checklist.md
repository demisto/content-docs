...
| Integration               | <ul><li>Code file</li><li>YML file</li><li>Description file</li><li>Image file</li><li>README file</li><li>Command examples file</li><li>Unit tests file</li><li>Unit tests data</li></ul> | <ul><li>Unit tests file</li><li>Unit tests data</li><li>Test Playbook</li><li>Custom Incidents (if *fetch_incidents* is supported)</li></ul> |
...
| Script                    | <ul><li>Code file</li><li>YML file</li><li>README file</li></ul>                                                                                               | <ul><li>Unit tests file</li><li>Unit tests data</li><li>Test Playbook</li></ul>             |
