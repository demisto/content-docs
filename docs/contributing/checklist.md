...
- Pack README (i.e. `Packs/YourPackName/README.md`): the readme of the pack file. More information [here](../integrations/pack-docs).
- Release Notes (i.e. `Packs/YourPackName/ReleaseNotes/1_0_1.md`): these are required only if you are updating an existing Content pack, not for the first. More information [here](../integrations/release-notes).
...
- README file (i.e. `Packs/YourPackName/Integrations/YourIntegrationName/README.md`): the integration documentation, mostly autogenerated (see [here](../integrations/integration-docs)).
- Command examples file (i.e. `Packs/YourPackName/Integrations/YourIntegrationName/command_examples`): are needed to [autogenerate](../integrations/integration-docs#command-examples) the documentation
...
- README file (i.e. `Packs/YourPackName/Playbooks/playbook-YourPlaybookName_README.md`): documentation file for the Playbook, mostly [autogenerated](../integrations/integration-docs#creating-documentation)
- Image file (i.e. `Packs/YourPackName/doc_files/YourPlaybookName.png`): image of the Playbook as exported from the XSOAR UI. Its link should be added to the README file as explained [here](../integrations/integration-docs#images)
...
| Integration               | <ul><li>Code file</li><li>YML file</li><li>Description file</li><li>Image file</li><li>README file</li><li>Command examples file</li><li>Unit tests file</li><li>Unit tests data</li></ul> |                                 |
