...
## What to contribute
If you’re looking for an easy way to start contributing Content to Cortex XSOAR, have a look at the issues labeled as [good first issue](https://github.com/demisto/content/labels/good%20first%20issue), which are small issues that would require easy patches.

These are issues that we believe are particularly well suited for external contributions. If you decide to start on an issue, assign yourself so that other people know that you're working on it.
## How to contribute
