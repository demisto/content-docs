...
For documentation contributions, please refer to [Documentation Contributions](docs-contrib).  
:::
...
Contribute from within Cortex XSOAR's UI using the [Marketplace](../contributing/marketplace).  
This method is more simple, and doesn't require to set up a development environment or be familiar with git.  
...
Because of these limitations, we do not recommend to use this method for large contributions, and we recommend to using it only in the following scenarios:
...
3. Setup a development environment by following the short [Development Setup](../concepts/dev-setup) guide, the more detailed [tutorial](../tutorials/tut-setup-dev), 
...
7. Create a [Pack Documentation](../documentation/pack-docs).  
...
:::note
If you are an XSOAR Technology Partner, make the [Cortex XSOAR Alliances Team](mailto:soar.alliances@paloaltonetworks.com) has reviewed your planned contribution, and that you have a *Partner ID* to associate your Pull Request to.
:::
...
5. Create a short demo video presenting the product and your pack, and link it.  
    This will help our reviewers to better understand what the product is used for, and the newly contributed content integrates with it.
...
Fill the description template, and click on **Create pull request**.
