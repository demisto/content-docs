...
Read about the architecture at [Architecture Basics](/docs/en/dev-architecture) and <a href="https://www.demisto.com/demisto-enterprise-under-the-hood/" target="_blank">Demisto Under The Hood</a>
...
Read about the [Architecture Basics](/docs/en/dev-architecture)
