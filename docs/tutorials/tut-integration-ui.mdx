...
import test_module_template from '!!raw-loader!./tut-integration-editor-files/test_module_template.py';
import test_module_solution from '!!raw-loader!./tut-integration-editor-files/test_module_solution.py';

import main_template from '!!raw-loader!./tut-integration-editor-files/main_template.py';
import main_solution from '!!raw-loader!./tut-integration-editor-files/main_solution.py';
...
<LearningEditor 
    original={test_module_template}
    solution={test_module_solution}
/>
...
<LearningEditor original={main_template} solution={main_solution} />
