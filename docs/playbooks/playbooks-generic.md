...
|---|---|---|
| [Account Enrichment - Generic v2.1](https://xsoar.pan.dev/docs/reference/playbooks/account-enrichment---generic-v21)  | Enriches accounts using one or more integrations. <br/>Supported integrations:<br/> -  Active Directory Query v2 | IAM |  
| [Block Account - Generic](https://xsoar.pan.dev/docs/reference/playbooks/block-account---generic)| Blocks malicious usernames using all integrations that you have enabled. <br/>Supported integrations:<br/> -  Active Directory Query v2<br/> - PAN-OS (This requires PAN-OS 9.1 or higher.) | IAM | 
...
| [Block File - Generic v2](https://xsoar.pan.dev/docs/reference/playbooks/block-file---generic-v2) | Blocks files from running on endpoints. <br/>Supported integrations: <br/>- Palo Alto Networks Traps <br/>- Palo Alto Networks Cortex XDR - Investigation and Response <br/>- Cybereason <br/>- Carbon Black Enterprise Response <br/>- Cylance Protect v2 | Endpoint |
...
|[Block IP - Generic v2](https://xsoar.pan.dev/docs/reference/playbooks/block-ip---generic-v2) |Blocks malicious IPs using all integrations that are enabled. <br/>Supported integrations: <br/>- Check Point Firewall <br/>- Palo Alto Networks Minemeld <br/>- Palo Alto Networks PAN-OS <br/>- Zscaler <br/>- FortiGate | Network Security |
|[Block URL - Generic](https://xsoar.pan.dev/docs/reference/playbooks/block-url---generic) | Blocks malicious URLs using all integrations that are enabled. <br/>Supported integrations: <br/>- Palo Alto Networks Minemeld <br/>- Palo Alto Networks PAN-OS <br/>- Zscaler | Network Security |
...
|[CVE Enrichment - Generic v2](https://xsoar.pan.dev/docs/reference/playbooks/cve-enrichment---generic-v2) | Performs CVE Enrichment. <br/>Uses the following integrations: <br/>- VulnDB <br/>- CVE Search v2 <br/>- IBM X-Force Exchange v2 | Data Enrichment and Threat Intelligence |
...
|[Domain Enrichment - Generic v2](https://xsoar.pan.dev/docs/reference/playbooks/domain-enrichment---generic-v2) | Enriches domains using one or more integrations.<br/>Domain enrichment includes: Threat information | Data Enrichment and Threat Intelligence |
...
|[Endpoint Enrichment - Generic v2.1](https://xsoar.pan.dev/docs/reference/playbooks/endpoint-enrichment---generic-v21) | Enriches an endpoint by hostname using one or more integrations. <br/>Supported integrations: <br/>- Active Directory Query v2 <br/>- McAfee ePO <br/>- Carbon Black Enterprise Response v2 <br/>- Cylance Protect v2 <br/>- CrowdStrike Falcon Host <br/>- ExtraHop Reveal(x) v2 | Endpoint |
