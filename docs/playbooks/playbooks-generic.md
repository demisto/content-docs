...
|[Block IP - Generic v2](https://xsoar.pan.dev/docs/reference/playbooks/block-ip---generic-v2) |Blocks malicious IPs using all 0f the enabled network security integrations. | Network Security |
