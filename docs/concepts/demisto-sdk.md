...
Also, Demisto SDK is designed to work on either macOS or Linux, if you are using Windows we support working through WSL. Please see [here](https://xsoar.pan.dev/docs/contributing/contrib-requirements#windows-users) for more information. 
