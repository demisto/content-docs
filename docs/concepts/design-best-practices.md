...
- Keep the generic playbooks in mind when designing integrations. Where applicable, add the relevant flow to the matching playbook. see the list of generic playbooks mapped by use cases [Here](../playbooks/playbooks-generic)
