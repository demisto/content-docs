...
All content on Marketplace is included in a Pack. (See [what can be in a pack](docs/integrations/packs-format). When Partners create a pack, they specify the content that is included in that pack. 
