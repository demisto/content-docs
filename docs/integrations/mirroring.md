...
* When switching between different mappers, that have different incident fields, for the mirroring to work with the new incident fields, you should delete the old incidents and re-fetch them with the newly configured mapper.
