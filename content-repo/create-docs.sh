...
if [ -z "${NETLIFY}" ]; then
    ...
    echo "---" >> ../docs/integrations/demisto-class.md
    echo "id: demisto-class" >> ../docs/integrations/demisto-class.md
    echo "title: Demisto Class" >> ../docs/integrations/demisto-class.md
    echo "---" >> ../docs/integrations/demisto-class.md
