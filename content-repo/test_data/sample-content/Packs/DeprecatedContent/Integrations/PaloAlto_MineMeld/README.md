...
<li>
<strong> <font style="vertical-align: inherit;">Blacklist names</font> </strong> <font style="vertical-align: inherit;">:</font> <font style="vertical-align: inherit;"> Comma separated list of miners, to be added to the Demisto block list. </font>
</li>
<li>
<strong> <font style="vertical-align: inherit;">Whitelist names:</font> </strong> <font style="vertical-align: inherit;"> CSV list of miners to add to the Demisto allow list.</font>
</li>
...
<p>For this command to succeed, the miner (associated with the IP address indicator) has to be on a Demisto block list or allow list.</p>
<h5>Base Command</h5>
<p><code>ip</code></p>
<h5>Input</h5>
<table style="width: 748px;" border="2" cellpadding="6">
...
<p>For this command to succeed, the miner (associated with the file indicator) has to be on a Demisto block list or allow list.</p>
<h5>Base Command</h5>
<p><code>file</code></p>
<h5>Input</h5>
<table style="width: 748px;" border="2" cellpadding="6">
...
<p>For this command to succeed, the miner (associated with the domain indicator) has to be on a Demisto block list or allow list.</p>
<h5>Base Command</h5>
...
<p>For this command to succeed, the miner (associated with the URL indicator) has to be on a Demisto block list or allow list.</p>
<h5>Base Command</h5>
<p><code>url</code></p>
<h5>Input</h5>
<table style="width: 748px;" border="2" cellpadding="6">
