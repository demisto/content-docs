...
:::note
If you have custom Mappers, Classifiers or Incident type attached to Integrations (OOTB or custom), after the initial upload using CI/CD you may need to reconfigure the Mappers, Classifiers and Incident type in the integrations instances.
:::
