# Cortex XSOAR Content Release Notes for version 20.12.0 (212192)
...
Indicates the object originated externally and was uploaded to Drive.
#### Incident Types
...
#### Integrations
##### RSS
Simple RSS reader than can ingest new items as Incidents.


---

### New: XM Cyber Pack v1.0.0 (Partner Supported)
#### Classifiers
##### XM Cyber Incident Classifier
Classifies XM Cyber alerts and events into 4 types.
...
Name of each attack technique that has compromised the entity and the count such attack vectors from the time period
- **Critical Assets At Risk**

- **Critical Assets at Risk Level**

- **Critical Assets at Risk List**
The average and minimum complexities of attacks to assets from this entity
- **Entity ID**
...
- **Entity Report**
Link to the Entity Report in XM Cyber
- **Entity Type**
...
### XM Cyber Pack v1.0.1 (Partner Supported)
#### Integrations
##### XM Cyber
