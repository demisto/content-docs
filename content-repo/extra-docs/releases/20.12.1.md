...
- [Synapse Pack v1.0.1](#ynapse-pack-v101-community-contributed)
...
#### Indicator Types
**Packs/Cryptocurrency/IndicatorTypes/reputation-cryptocurrency.json**
...
Classifies all incidents fetched by the Darktrace integration as "Darktrace Model Breach" type incidents for purposes of using the Integration Playbooks.
...
Number of comments on the Darktrace model breach
- **Darktrace Device Hostname**
Hostname associated with device in Darktrace
- **Darktrace Device ID**

- **Darktrace Device IP**
IP address associated with device in Darktrace
- **Darktrace Device Label**
Device label associated with device in Darktrace
- **Darktrace Device MAC**
MAC address associated with device in Darktrace
- **Darktrace Device Vendor**
Vendor associated with device in Darktrace
- **Darktrace Model Breach Description**
Description of the Model Breach
- **Darktrace Model Breach ID**
Darktrace Model Breach ID (PBID) of the breached model
- **Darktrace Model Breach Score**
Darktrace Model Breach Score
- **Darktrace Model ID**
Model ID (PID) associated with the breached model in Darktrace
- **Darktrace Model Name**
Name associated with the breached model in Darktrace
- **Darktrace Model Priority**
Priority of the breached model in Darktrace
- **Darktrace Model Tags**
Tags associated with the breached Darktrace model
- **Darktrace Model UUID**
Model UUID associated with the breached model in Darktrace
#### Incident Types
...
- **Validity Not Before**
Starting of certificate validity period
#### Indicator Types
- **Packs/X509Certificate/IndicatorTypes/reputation-Certificate.json**
...
Enrich and calculate the reputation of a certificate indicator.
