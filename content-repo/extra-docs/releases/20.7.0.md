...
#### Integrations
##### Service Desk Plus  
Use this integration to manage Service Desk Plus requests. The integration allows you to create, update and delete requests; Assign groups and technician to requests; Link and unlink requests and change their resolution.
