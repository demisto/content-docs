...
Creates relationships between indicators.

##### New: SearchIndicatorRelationships
Searches for relationships according to given arguments.

##### New: DeleteIndicatorRelationships
Deletes a relationship between indicator objects based on the relationship ID.
