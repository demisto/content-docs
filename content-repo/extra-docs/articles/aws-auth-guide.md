...
* **Assume role**: Provide the ARN of the role you want to assume. The integration will use the AWS Security Token Service (STS) to assume the role on your behalf. See below more information about STS.
