...
| [FireEye HX](https://cortex.marketplace.pan.dev/marketplace/details/FireEyeHX/) (integration [FireEye Endpoint Security (HX) v2](https://xsoar.pan.dev/docs/reference/integrations/fire-eye-hx-v2)) | <ul><li>Perform triage data acquisition from endpoint and fetch the data as a MANS file with commands `fireeye-hx-data-acquisition`, `fireeye-hx-initiate-data-acquisition`, and `fireeye-hx-get-data-acquisition`</li><li>The MANS file can then be passed into FireEye HX apps like [Redline](https://fireeye.market/apps/211364) for further analysis</li></ul> |
